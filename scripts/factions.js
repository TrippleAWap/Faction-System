...
world.events.beforeChat.subscribe((data) => {
    ...
    if (message.startsWith(".")) {
        ...
        if (args[0] === "debug") player.sendMessage(JSON.stringify(dB))
...
`)
            ...
            if (args[1] === "create") {
                ...
                if (dB.factions.includes(factionName)) {
                    ...
                    dB.factions.push({ name: factionName, officers: [], members: [data.sender.name], leader: data.sender.name, power: 0, home: { x: 0, y: 0, z: 0 }, enemies: [] })
